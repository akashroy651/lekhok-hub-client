...
const Register = () => {
  ...
  // console.log('in register', location)
    ...
    const handleRegistration = (data) => {
        ...
        // console.log('after register photo', data.photo[0])
      ...
      .then(() => {
        ...
        //2. send the to store and get the photo url
  ...
  return (
    <div className="card bg-base-100 w-full mx-auto max-w-sm shrink-0 shadow-2xl">
       <h2 className="text-3xl text-center">Welcome to Lekhok Hub </h2>
      ...
      <form onSubmit={handleSubmit(handleRegistration)} className="card-body">
        <fieldset className="fieldset">
          ...
          <input type="text" {...register('name',{required:true})} className="input" placeholder="Your Name"/>
            {errors.name?.type==='required' && <p className="text-red-500 font-semibold"
            >Name is required</p>}
          ...
          <input type="file" {...register('photo',{required:true})} className="file-input" placeholder="Photo URL" />
            {errors.photo?.type==='required' && <p className="text-red-500 font-semibold"
            >Photo is required</p>}
